                         ...
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        <h1>E_WeJob</h1>
                                        <h3>Online Job Website It contains a list of jobs and jobs candidates.<br/>
                                         Find Our mobile app.</h3>
                    ...
                    <div class="item item-second">
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        <h1>Find Your Job.</h1>
                                        <h3>Do not hesitate contact us for more information.</h3>
                                        <a href="jobs.html" class="section-btn btn btn-default">Browse Jobs</a>
                                   </div>
                              </div>
                         </div>
                    ...
                    <div class="row">
                         <div class="col-md-12 col-sm-12">
                              <div class="text-center">
                                   ...
                                   <p class="lead">SVU Project E_Wejob online Website help you
                                   to find your job As soon and effeciant as possible.</p>
                              </div>
                         </div>
                    </div>
               </div>
          ...
          <section id="Candidates">
               <div class="container">
                    <div class="row">
                         ...
                         <div class="col-md-12 col-sm-12">
                              <div class="section-title text-center">
                                   <h2>Candidates <small>from around the world</small></h2>
                              </div>
